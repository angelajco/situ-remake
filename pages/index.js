...
export default function Home() {
  return (
    <>
      ...
      <main>
        <section>
          <img src="/images/situ-inst.png" className="tw-w-full" alt="Sistema de Información Territorial y Urbana SITU"/>
        </section>
        ...
        <section className="custom-max-width custom-mx-t-2">
            ...
            <div className="row ">
              <div className="col-xl-3 col-lg-3 col-md-6 col-sm-6 col-xs-12 custom-mx-b-1">
                <a href="https://www.snieg.mx/" target="_blank" className={classes}>
                  <div className="row justify-content-center">
                    <img src="/images/index/curvas_nivel2_.jpg" className="interesting-sites-images"/>
                  </div>
                  <div className="row justify-content-center">
                    <h5>
                      <b>
              ...
              <div className="col-xl-3 col-lg-3 col-md-6 col-sm-6 col-xs-12 custom-mx-b-1">
                <a href="http://gaia.inegi.org.mx/" target="_blank" className={classes}>
                  <div className="row justify-content-center">
                    <img src="/images/index/curvas_nivel_.jpg" className="interesting-sites-images"/>
                  </div>
                  <div className="row justify-content-center">
                    <h5>
                      <b>
              ...
              <div className="col-xl-3 col-lg-3 col-md-6 col-sm-6 col-xs-12 custom-mx-b-1">
                <a href="https://sig.ran.gob.mx/acceso.php" target="_blank" className={classes}>
                  <div className="row justify-content-center">
                    <img src="/images/index/curvas_nivel3.jpg" className="interesting-sites-images"/>
                  </div>
                  <div className="row justify-content-center">
                    <h5>
                      <b>
              ...
              <div className="col-xl-3 col-lg-3 col-md-6 col-sm-6 col-xs-12 custom-mx-b-1">
                <a href="https://iieg.gob.mx/" target="_blank" className={classes}>
                  <div className="row justify-content-center">
                    <img src="/images/index/curvas_nivel4.jpg" className="interesting-sites-images"/>
                  </div>
                  <div className="row justify-content-center">
                    <h5>
                      <b>
